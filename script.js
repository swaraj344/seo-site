...
var CLI = {
    ...
    attachEvents: function () {
        ...
        jQuery('.cli_action_button').on("click", function (e) {
            ...
            var open_link = elm[0].hasAttribute("href") && elm.attr("href") != '#' ? !0 : !1;
            var new_window = !1;
            if (button_action == 'accept') {
                CLI.accept_close();
                new_window = Boolean(CLI.settings.button_1_new_win) ? !0 : !1
                ...
                CLI.reject_close();
                new_window = Boolean(CLI.settings.button_3_new_win) ? !0 : !1
            }
            if (open_link) {
                if (new_window) {
